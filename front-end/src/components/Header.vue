...
@font-face {
  font-family: 'custom-icons';
  src: url('../../static/custom-icons/font/custom-iconsf59a.eot?46333765');
  src: url('../../static/custom-icons/font/custom-iconsf59a.eot?46333765#iefix') format('embedded-opentype'),
  url('../../static/custom-icons/font/custom-iconsf59a.woff?46333765') format('woff'),
  url('../../static/custom-icons/font/custom-iconsf59a.ttf?46333765') format('truetype'),
  url('../../static/custom-icons/font/custom-iconsf59a.svg?46333765#custom-icons') format('svg');
  font-weight: normal;
  font-style: normal;
}
