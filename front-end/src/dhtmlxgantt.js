...
dhtmlxGantt v.6.1.6 Professional Evaluation
    ...
    return function (t) {
        ...
        function r(t) {
            if (t._delayRender && t._delayRender.$cancelTimeout(), t.$gantt) {
                var e = t.$gantt.$data.tasksStore, i = t.$config.rowStore, n = "_attached_" + i.$config.name;
            ...
            return {
                init: function () {
                    ...
                    if (this.$config.rowStore && this.$gantt.$data.tasksStore) {
                        var t = this.$gantt.$data.tasksStore, e = this.$config.rowStore;
                        r(this);
                    ...
                    var t = this.$gantt, e = t.getDatastore(t.config.resource_store);
        ...
        var n = i(1), r = i(0), a = i(4), o = i(128), s = i(32), l = function (t, e, i, n) {
        ...
        l.prototype = {
            init: function (t) {
                ...
                var l = o(e, this);
                l.init(), this._renderHeaderResizers = l.doOnRender, this._mouseDelegates = i(15)(e), this._addLayers(this.$gantt), this._initEvents(), this.callEvent("onReady", [])
        ...
        var n = i(28), r = i(0), a = i(29), o = function (t) {
        ...
        var n = i(28), r = i(0), a = i(4), o = function (t) {
        ...
        var n = i(0), r = i(34), a = i(14), o = i(2), s = function (t) {
            function e(e, i, n, r) {
                ...
                init: function () {
                    ...
                    return {
                        tasks: [{
                            ...
                            filter: [e]
                        }, {renderer: this.$gantt.$ui.layers.taskBg, container: this.$task_bg, filter: [e]}], links: []
                    }
                }
        ...
        var n = i(33), r = i(4), a = i(0), o = i(32), s = i(129), l = function (t, e, i, o) {
        ...
        t.exports = function (t) {
            ...
            return n(r, e), r.prototype.render = function (i) {
                var n = t.config.types, r = t.locale.labels, a = [], o = i.filter || function (t, e) {
                    return !n.placeholder || e !== n.placeholder
                };
                for (var s in n) !1 == !o(s, n[s]) && a.push({key: n[s], label: r["type_" + s]});
                i.options = a;
                var l = i.onchange;
        ...
        t.exports = function (t) {
            ...
            return t.attachEvent("onAfterLightbox", function () {
                ...
                !function (t, e) {
                    ...
                    var l = function (r) {
                        ...
                        f = g.checkbox, h = g.input, u = f.checked, c = function (t) {
                            ...
                            if (a) {
                                ...
                                } else for (var u in s.resourcesValues[e.id]) {
                                    var d = n.arrayFind(c, function (t) {
                                        return t.id == u
                                    });
                                    d || c.push({resource_id: u, value: s.resourcesValues[e.id][u]})
                                }
                                for (var h = {}, f = 0; f < c.length; f++) h[c[f].resource_id] = !0;
                                o = function (t) {
                                    if (h[String(t.key)] && ("" === r || t.label.indexOf(r) >= 0)) return t
                                }
                            } else {
                                if ("" === r) return e;
                                o = function (t) {
                    ...
                    function h(e) {
                        ...
                        if ("checkbox" === e.target.type) {
                            ...
                            var l = n.getAttribute("data-item-id"), u = r.locateClassName(e, "gantt_resource_row"),
                                d = u.querySelector(".gantt_resource_amount_input");
                            if (u.setAttribute("data-checked", o.checked), o.checked) {
                                "select" === n.nodeName.toLowerCase() && t.callEvent("onResourcesSelectActivated", [{target: n}]);
                                var h = l, _ = a.default_value;
                    ...
                    l.unassigned_value != t.key && (h = function (t, e, i) {
                        ...
                        var n, r = "";
                        if (!t) return;
                        n = [{key: "data-item-id", value: t.key}, {
                            key: "class",
                            value: "gantt_resource_amount_input"
                        }], i && n.push({key: "disabled", value: "disabled"});
                ...
                var r = u(i), a = [], o = c(!0), l = c(!1), h = d(i), f = e[i.map_to] || [], _ = {};
                ...
                for (v = 0; v < g.length; v++) {
                    var m = g[v].getAttribute("data-item-id"), y = g[v].value.trim();
                    "" !== y && "0" !== y && (delete _[m], a[a.length] = {resource_id: m, value: y})
                }
        ...
        t.exports = function (t) {
            var e = i(1), n = i(3), r = i(64)(t), a = i(63)(t), o = i(62)(t), s = i(12)(t), l = i(61)(t), c = i(60)(t),
                u = i(59)(t), d = i(58)(t), h = i(57)(t), f = i(56)(t);
        ...
        var n = i(74), r = i(69), a = i(67), o = i(0);
        t.exports = function (t) {
        ...
        var n = i(3), r = function () {
            ...
            return t.prototype.attach = function () {
                var t = this.$dp, e = this.$gantt, n = i(25), r = {};
        ...
        "use strict";
        Object.defineProperty(e, "__esModule", {value: !0});
        var n = i(4), r = i(3), a = i(0), o = i(92), s = i(91);
        ...
        var n = i(0), r = i(98), a = i(97), o = i(29), s = i(27), l = i(96), c = i(95);
        ...
        var n = i(1), r = function (t, e) {
            ...
            h.attachEvent("onBeforeDragStart", e.bind(function (i, r) {
                ...
                var S = !(v == d && g == y && m == b);
                return S && (g && e.refreshTask(g, !1), y && e.refreshTask(y, !1)), S && _(c.marker), function (i, n, r, a) {
                    var o = function () {
        ...
        var n = i(0), r = i(105), a = i(104), o = i(1), s = function (t) {
            var e = t.$services;
            return {
                onCreated: function (e) {
                    var o = e.$config;
                    o.bind = n.defined(o.bind) ? o.bind : "task", o.bindLinks = n.defined(o.bindLinks) ? o.bindLinks : "link", e._linksDnD = a.createLinkDND(), e._tasksDnD = r.createTaskDND(), e._tasksDnD.extend(e), this._mouseDelegates = i(15)(t)
                }, onInitialized: function (e) {
        ...
        var n = i(1), r = i(13), a = i(109), o = i(108), s = i(107);
        t.exports = {
            init: function (t, e) {
        ...
        t.exports = function (t) {
            var e = i(7)(t), n = i(0), r = "%Y-%m-%d", a = null, o = null;
        ...
        var n = i(124), r = i(121), a = i(120), o = i(119), s = i(118), l = i(117), c = i(0), u = i(1), d = i(4);
        ...
        var n = i(0), r = i(31), a = i(14), o = i(2), s = function (t) {
            function e(e, i, n, r) {
                var a = t.apply(this, arguments) || this;
                return a.$config.bindLinks = null, a
            }
        ...
        var n = i(1), r = i(0), a = i(14), o = i(16), s = i(2), l = function (t) {
            function e(e, i, n, r) {
        ...
        t.exports = function (t, e) {
            var i = {
                column_before_start: t.bind(function (t, i, r) {
                    ...
                    var o = this.locate(r, a.grid_resizer_column_attribute), s = e.getGridColumns()[o];
                    ...
                    var o = e.$getConfig(), s = i.config, l = e.getGridColumns(), c = parseInt(s.drag_index, 10),
                        u = l[c], d = n.getNodePosition(e.$grid_scale), h = parseInt(s.marker.style.left, 10),
                        f = u.min_width ? u.min_width : o.min_grid_column_width, _ = e.$grid_data.offsetWidth, g = 0,
                        p = 0;
                    ...
                    if (c.max_width && c.max_width < d && (d = c.max_width), !1 !== e.callEvent("onColumnResizeEnd", [l, c, d]) && c.width != d) {
                        if (c.width = d, a.keep_grid_width) s = a.grid_width; else {
                            u = l;
            ...
            return {
                init: function () {
                    var n = t.$services.getService("dnd"), r = e.$getConfig(),
                        a = new n(e.$grid_scale, {updates_per_second: 60});
        ...
        var n = i(0), r = i(8), a = function (t, e) {
            var i = {}, n = "gantt-static-bg-styles-" + t.uid();
            ...
            function l(t, e, i) {
                var n = Math.floor(500 / t) || 1, a = Math.floor(500 / e) || 1, o = document.createElement("canvas");
                o.height = e * a, o.width = t * n;
                var s = o.getContext("2d");
                return function (t, e, i, n, a, o) {
                    var s = a.createImageData(e * n, t * i);
                    s.imageSmoothingEnabled = !1;
                    for (var c = 1 * o.rightBorderWidth, u = r(o.rightBorderColor), d = 0, h = 0, f = 0, _ = 1; _ <= n; _++) for (d = _ * e - 1, f = 0; f < c; f++) for (h = 0; h < t * i; h++) l(d - f, h, u, s);
                    var g = 1 * o.bottomBorderWidth, p = r(o.bottomBorderColor);
                    h = 0;
                    for (var v = 1; v <= i; v++) for (h = v * t - 1, f = 0; f < g; f++) for (d = 0; d < e * n; d++) l(d, h - f, p, s);
                            ...
                            for (var f = 0; f < c.length; f++) {
                                ...
                                if (_ != o && void 0 !== o || f == c.length - 1 || l > d) {
                                    for (var g = r, p = 0, v = Math.floor(d / i.row_height) * i.row_height, m = l; g > 0;) {
                                        var y = Math.min(g, v);
                                        g -= v, (a = document.createElement("div")).style.height = y + "px", a.style.position = "absolute", a.style.top = p + "px", a.style.left = u + "px", a.style.whiteSpace = "no-wrap", a.className = t[o || _], f == c.length - 1 && (m = _ + m - 1), a.style.width = m + "px", s.push(a), p += y
                                    }
                                    l = 0, u += m
                                }
                                _ && (l += _, o = _)
        ...
        var n = i(2), r = i(1), a = i(0), o = i(6), s = function (t) {
            "use strict";
        ...
        var n = i(2), r = i(35), a = i(6), o = function (t) {
            "use strict";
        ...
        var n = i(140), r = i(138), a = i(137), o = i(6), s = i(35), l = i(134), c = i(133), u = i(132), d = i(131),
            h = i(34), f = i(16), _ = i(127), g = i(31), p = i(126), v = i(125), m = i(30), y = i(116), b = i(115),
            k = i(114), w = i(113), x = i(112), $ = i(106), S = i(103);
        t.exports = {
            init: function (t) {
                function e(e, i) {
                    var n = i(t);
                ...
                return function t(e, i, n) {
                    ...
                    1: [function (t, e, i) {
                        ...
                        i.exports = function (i, n) {
                            ...
                            i.longStackTraces = function () {
                                ...
                                if (!Z.longStackTraces && Y()) {
                                    ...
                                    }, i.prototype._captureStackTrace = R, i.prototype._attachExtraTrace = z, i.prototype._dereferenceTrace = H, n.activateLongStackTraces(), l.disableTrampolineIfNecessary()
                                }
                            ...
                            i.config = function (t) {
                                ...
                                if ("cancellation" in t && t.cancellation && !Z.cancellation) {
                                    ...
                                    i.prototype._clearCancellationData = N, i.prototype._propagateFrom = L, i.prototype._onCancel = M, i.prototype._setOnCancel = P, i.prototype._attachCancellationCallback = A, i.prototype._execute = I, O = L, Z.cancellation = !0
                                }
                            ...
                            return k && i.longStackTraces(), {
                                ...
                                }, CapturedTrace: K, fireDomEvent: $, fireGlobalEvent: S
                            }
                        }
                        ...
                        i.exports = function () {
                            ...
                            }, c.notEnumerableProp(D, "_makeSelfResolutionError", n), t("./method")(D, p, y, a, x), t("./bind")(D, p, y, x), t("./cancel")(D, b, a, x), t("./direct_resolve")(D), t("./synchronous_inspection")(D), t("./join")(D, b, y, p, h, s), D.Promise = D, D.version = "3.5.4", t("./map.js")(D, b, a, y, p, x), t("./call_get.js")(D), t("./using.js")(D, a, y, w, p, x), t("./timers.js")(D, p, x), t("./generators.js")(D, a, p, y, o, x), t("./nodeify.js")(D), t("./promisify.js")(D, p), t("./props.js")(D, b, y, a), t("./race.js")(D, p, y, a), t("./reduce.js")(D, b, a, y, p, x), t("./settle.js")(D, b, x), t("./some.js")(D, b, a), t("./filter.js")(D, p), t("./each.js")(D, p), t("./any.js")(D), c.toFastProperties(D), c.toFastProperties(D.prototype), M({a: 1}), M({b: 2}), M({c: 3}), M(1), M(function () {
        ...
        i(19), t.exports = function () {
            var t = new function () {
                this.constants = i(156), this.version = "6.1.6", this.templates = {}, this.ext = {}, this.keys = {
            ...
            var s = i(20)();
            t.event = s.attach, t.eventRemove = s.detach, t._eventRemoveAll = s.detachAll, t._createDomEventScope = s.extend, a.mixin(t, i(142)(t));
            var l = i(141).init(t);
        ...
        var n = {
            ...
            }, _ganttPlugin: [], getGanttInstance: function () {
                for (var t = i(157)(), e = 0; e < n._ganttPlugin.length; e++) n._ganttPlugin[e](t);
